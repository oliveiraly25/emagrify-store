          ...
          {loading ? (
            ...
            <>
              {!user && (
                <Link
                  href="/login-auth"
                  className="px-4 py-2 rounded-full bg-black dark:bg-[#222] text-white font-medium hidden sm:block"
                >
                  Entrar / Registrar
                </Link>
              )}
              ...
              {user && (
                <div className="relative" ref={menuRef}>
                  <div
                    className="w-10 h-10 bg-gray-200 dark:bg-[#333] rounded-full flex items-center justify-center cursor-pointer"
